export default async function getUsuarios(emailUser) {
  try {
    ...
    if (!response.ok) {
      throw new Error("Ha habido un error al recuperar los usuarios");
    }
...
export async function comprobarEmail(email) {
  try {
    ...
    if (!response.ok) {
      throw new Error("Ha habido un error al comprobar el email");
    }
...
export async function crearUsuario(datosUsuario) {
  try {
    ...
    if (!response.ok) {
      throw new Error("Ha habido un error al añadir un usuario");
    }
...
export async function iniciarSesion(datosUsuario) {
  try {
    ...
    if (!response.ok) {
      throw new Error("Ha habido un error al añadir iniciar sesion");
    }
...
export async function recuperarEquipamientos() {
  try {
    ...
    const response = await fetch("http://localhost/api/api.php", {
      method: "POST",
      body: JSON.stringify({
        recuperarEquipamientos: "recuperarEquipamientos",
      }),
      headers: {
        "Content-Type": "application/json",
      },
...
export async function crearEntreno(datos) {
  try {
    ...
    if (!response.ok) {
      throw new Error("Ha habido un error al añadir un entreno");
    }
...
export async function borrarUsuario(usuarioID) {
  try {
    ...
    console.log(response);
    if (!response.ok) {
      throw new Error("Ha habido un error al borrar el usuario");
    }
    const responseData = await response.json();
    return responseData;
  } catch (error) {
...
export async function editarUsuario(datosUsuario) {
  try {
    console.log("me llaman");
    const response = await fetch("http://localhost/api/api.php", {
      method: "POST",
      body: JSON.stringify({ editarUsuario: datosUsuario }),
      // No es necesario establecer 'enctype' aquí
    });
