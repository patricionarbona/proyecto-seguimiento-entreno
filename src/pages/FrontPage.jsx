        ...
        <>
            ...
            <div className="mt-24 flex flex-col  h-[94vh]">
                <div className="h-[47vh] flex flex-col sm:flex-row justify-between mt-4 w-11/12 mx-auto ">
                    <div className="bg-royal-blue-100 h-full w-3/12 rounded-2xl shadow-sm ">EJERCICIO</div>
                    <div className="bg-royal-blue-100 h-full w-7/12 rounded-2xl shadow-sm ">GRAFICA</div>
                </div>
